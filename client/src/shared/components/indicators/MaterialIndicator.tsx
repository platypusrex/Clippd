...
import { materialIndicatorStyles as styles} from '../../../styles/shared/MaterialIndicatorStyles';
...
type Props = MaterialIndicatorProps & IndicatorProps;

export class MaterialIndicator extends React.PureComponent<Props, {}> {
  ...
  renderComponent({index, count, progress}: RenderComponentProps) {
    const {size, color, animationDuration} = this.props as Props & DefaultProps;
